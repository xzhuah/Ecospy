...
//        });
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_quit);
        navigationView.setNavigationItemSelectedListener(this);

        btn1=(ImageButton)findViewById(R.id.btn5_1);
        btn2=(ImageButton)findViewById(R.id.btn5_2);
        btn3=(ImageButton)findViewById(R.id.btn5_3);
        btn4=(ImageButton)findViewById(R.id.btn5_4);
        btn5=(ImageButton)findViewById(R.id.btn5_5);
