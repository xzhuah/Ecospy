            ...
            public void onClick(View v) {
                if (dialog != null && dialog.isShowing()) {
                    ...
                    if(type==1){
                        ...
                        try {
                            Toast.makeText(CameraMain.this, "已回收废纸，得到木材3件", Toast.LENGTH_LONG).show();
                        ...
                        try {
                            Toast.makeText(CameraMain.this, "已回收木材，得到木材5件", Toast.LENGTH_LONG).show();
                        ...
                        try {
                            Toast.makeText(CameraMain.this, "已回收鞋子1双，得到塑料3件", Toast.LENGTH_LONG).show();
                        ...
                        try {
                            Toast.makeText(CameraMain.this, "已回收塑料制品，得到塑料3件", Toast.LENGTH_LONG).show();
                            UserPO.itembag.put(4,UserPO.itembag.get(4)+3);
                        ...
                        Toast.makeText(CameraMain.this, "没有可回收的物品", Toast.LENGTH_LONG).show();
                    }
                    UserPO.updateOnline();
