...
public class GameMain extends AppCompatActivity
    ...
    private View.OnClickListener navBar=new NavSwitcher(GameMain.this,2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemButtonGroup ig=new ItemButtonGroup(GameMain.this);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_11),0,0);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_12),0,1);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_13),0,2);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_21),1,0);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_22),1,1);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_23),1,2);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_31),2,0);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_32),2,1);
        ig.setItemButton((ImageButton)findViewById(R.id.gamebtn_33),2,2);
        ig.setResultButton((ImageButton) findViewById(R.id.result1), 0);
      // ig.setResultButton((ImageButton)findViewById(R.id.result2),1);
       ig.setTextView(num1, 0);
      //  ig.setTextView(num2,1);
        ig.addListener();
